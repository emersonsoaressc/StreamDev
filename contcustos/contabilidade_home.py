...
def contc():
    ...
    if tema == 'Planejamento Financeiro Pessoal':
        ...
        if box_cont == 'Conceito':
            ...
            st.write(df_dre)
            st.warning(f'A soma das despesas fixas, variáveis e financeiras correspondem a {(total_despfixas+total_despvariaveis+total_despfinanceiras):.2f}% das receitas totais')
